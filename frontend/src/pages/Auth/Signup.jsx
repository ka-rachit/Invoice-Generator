...
import {Eye, EyeOff, Loader2, Mail, Lock, FileText, ArrowRight, User, Phone} from "lucide-react";
...
const Signup = () => {
    ...
    const handleSubmit = async () => {
        ...
        const nameError = validateName(formData.name);
        const emailError = signupMethod === "email" ? validateEmail(formData.email) : "";
        const phoneError = signupMethod === "phone" ? validatePhone(formData.phone) : "";
        const passwordError = validatePassword(formData.password);
        const confirmPasswordError = validateConfirmPassword(formData.confirmPassword, formData.password);
