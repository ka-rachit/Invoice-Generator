...
import {Eye, EyeOff, Loader2, Mail, Lock, FileText, ArrowRight, Phone} from "lucide-react";
import {API_PATHS} from "../../utils/apiPaths";
import {useAuth} from "../../context/AuthContext";
import axiosInstance from "../../utils/axiosInstance";
import {useNavigate} from "react-router-dom";
import {validateEmail, validatePassword, validatePhone} from "../../utils/helper";
...
const Login = () => {
    ...
    const handleInputChange = (e) => {
        ...
        if (touched[name]) {
            ...
            if (name === "email") {
                ...
                newFieldErrors.phone = validatePhone(value);
    ...
    const isFormValid = () => {
        ...
        if (loginMethod === "email") {
            ...
            return !phoneError && !passwordError && formData.phone && formData.password;
        }
    };

    const handleSubmit = async () => {
        // Validate all fields before submission
        const emailError = loginMethod === "email" ? validateEmail(formData.email) : "";
        const phoneError = loginMethod === "phone" ? validatePhone(formData.phone) : "";
        const passwordError = validatePassword(formData.password);
