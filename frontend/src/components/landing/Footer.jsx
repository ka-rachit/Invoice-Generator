            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
                ...
                <div className='border-t border-gray-800 py-8 mt-16'>
                    <div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
                        <p className='text-gray-400'>&copy; 2026 Invoice Generator. All rights reserved.</p>
                        <div className='flex space-x-4 '>
                            <SocialLink href="mailto:rachitkawediya06@gmail.com">
                                <Mail className='w-5 h-5' />
                            </SocialLink>
                            <SocialLink href="https://github.com/ka-rachit">
                                <Github className='w-5 h-5' />
                            </SocialLink>
                            <SocialLink href="https://www.linkedin.com/in/rachitkawediya">
